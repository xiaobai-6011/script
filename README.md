...
```bash
# 下载脚本
wget -N https://raw.githubusercontent.com/xiaobai-6011/script/private/ocserv.sh
chmod +x ocserv.sh
...
## 更新日志
- v1.4.1: 添加法律声明，优化DNS配置，增加单设备限制
- v1.4.0: 优化源配置，CentOS 7/8使用Vault源，证书随机生成
- v1.3.x: 添加流量统计、用户限速、SSH bypass
- v1.2.x: 完善多系统兼容

## 下载
- 主分支: https://raw.githubusercontent.com/xiaobai-6011/script/main/ocserv.sh
- 私有分支: https://raw.githubusercontent.com/xiaobai-6011/script/private/ocserv.sh
